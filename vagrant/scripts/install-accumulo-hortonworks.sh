...
sed -i -e "s|HADOOP_PREFIX=/path/to/hadoop|HADOOP_PREFIX=/usr/hdp/2.2.6.0-2800/hadoop|" \
	-e "s|HADOOP_HDFS_PREFIX=/path/to/hadoop-hdfs|HADOOP_HDFS_PREFIX=/usr/hdp/2.2.6.0-2800/hadoop-hdfs|" \
    -e "s|JAVA_HOME=/path/to/java|JAVA_HOME=/opt/jdk|" \
    -e "s|ZOOKEEPER_HOME=/path/to/zookeeper|ZOOKEEPER_HOME=/usr/hdp/2.2.6.0\-2800/zookeeper|" \
